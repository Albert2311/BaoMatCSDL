...
BEGIN
	...
	VALUES (@MANV, @HOTEN, @EMAIL, @LUONGVARBINARY, @TENDN, @MATKHAUVARBINARY)
END
SELECT * FROM NHANVIEN
EXEC SP_INS_PUBLIC_NHANVIEN 'NV03', 'ANH3', 'NVA@', 3000000, 'NVANH3', 'abcd12'
...
AS
BEGIN 
	SELECT MANV, HOTEN, EMAIL, CONVERT(varchar(max), DECRYPTBYASYMKEY(ASYMKEY_ID('AK01'), LUONG, N'46.01.104.005')) AS LUONGCB
	FROM NHANVIEN
	WHERE @TENDN = TENDN AND CONVERT(VARBINARY(MAX), HASHBYTES('SHA1', @MATKHAU), 2) = MATKHAU
END

EXEC SP_SEL_PUBLIC_NHANVIEN N'NVANH3', 'abcd12'
...
EXEC SP_INS_PUBLIC_NHANVIEN 'NV03', 'NVANH3', 'nva@yahoo.com', 3000000, 'NVANH3', '123456'
EXEC SP_INS_PUBLIC_NHANVIEN 'NV04', 'NVANH4', 'nvb@yahoo.com', 2000000, 'NVANH3', '1234567'
