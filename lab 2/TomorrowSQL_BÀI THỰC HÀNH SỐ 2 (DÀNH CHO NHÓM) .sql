...
--------------------------------------------------------------------------
--cau h
/*Giả  sử  trong  CSDL  có  100  stored  procedure,  có  cách  nào để  Encrypt  toàn  bộ  100  stored procedure 
trước khi cài đặt cho khách hàng không? Nếu có, hãy mô tả các bước thực hiện. */
...
-- cau 1
--Cho  biết mã  số,  họ  tên,  ngày  sinh, địa  chỉ và vị  trí  của  các  cầu  thủ  thuộc đội bóng “SHB Đà Nẵng” có quốc tịch “Brazil”. 
go
